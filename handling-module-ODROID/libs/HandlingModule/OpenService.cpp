...
class OpenService: public Service{
...
public:
    ...
    OpenService():Service(){
        ...
        this->service=false;
    	Service::registerClass(name, &OpenService::create);
    
    }
    
    OpenService(string name, list<string> params, bool interruptible, bool service) :
